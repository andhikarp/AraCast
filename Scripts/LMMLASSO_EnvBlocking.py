#Leave One Planting Out Cross-Validation (environmental blocking)
import sys
...
env=pd.read_csv('Microclimate_Monthly_threshold_0_0.csv',sep=',')
...
for j in exclplanting:
	...
	for_plotting.to_csv("LOO_"+j+"_monthly.csv",header=True,sep=',')
	weights = lasso.coef_
	...
	np.save("LOOresults_"+j+"_monthly.npy",results)
